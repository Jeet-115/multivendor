...
<head>
  <style>
    .hero
    {
      background-image: url('https://wallpapers.com/images/hd/handshake-pictures-1f6j7wnwrpif69ka.jpg');  /* Replace 'path/to/your/image.jpg' with the actual path to your image file */
...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
  ...
  <main id="main">
    ...
    <section id="hero" class="hero">
      <div class="container">
      <h2 data-aos="fade-up" data-aos-delay="100">CUSTOMER PLEASE FILL YOUR DETAILS</h2>
      <div class="col-lg-12 entries">
      <form action="process_customer.php" method="post" enctype='multipart/form-data'  data-aos="fade-up" data-aos-delay="100">
      <hr>
